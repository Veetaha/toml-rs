...
test!(
    ...
    "invalid escape character in string: `a` at line 1 column 41"
);
test!(
    string_bad_line_ending_escape,
    include_str!("invalid/string-bad-line-ending-escape.toml"),
    "whitespace trimming escape is not the last on the line at line 2 column 78"
);
test!(
    string_byte_escapes,
    include_str!("invalid/string-byte-escapes.toml"),
    "invalid escape character in string: `x` at line 1 column 11"
);
test!(
    string_no_close,
